...
function whmcs_domain_checker_init_slider(){
	jQuery('.slider').remove();
	jQuery('.whmcs_domain_checker_simple_slider').each(function(k,v){
		var slide = jQuery(v);
		slide.simpleSlider({
...
jQuery(function($){
	//whmcs_domain_checker_field_callbacks.push('whmcs_domain_checker_init_slider');
	whmcs_domain_checker_init_slider();
	$(document).ajaxSuccess(function(e, xhr, settings) {
		if(settings.data){
			if(settings.data.search('action=save-widget') != -1 && settings.data.search('whmcs_domain_checker') != -1) {
				whmcs_domain_checker_init_slider();
			}
		}
	});
